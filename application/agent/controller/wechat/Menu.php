...
namespace app\agent\controller\wechat;

use app\common\controller\BackendAgent;
use app\agent\model\WechatResponse;
 ...
 * @icon fa fa-list-alt
 */
class Menu extends BackendAgent
{
    ...
    {
        parent::_initialize();
        $this->wechatcfg = \app\agent\model\WechatConfig::get(['name' => 'menu']);
    }
