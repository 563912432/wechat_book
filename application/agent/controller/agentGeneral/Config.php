...
class Config extends BackendAgent
{
    ...
    /**
     * @var \app\common\model\AgentConfig
     */
    ...
    protected function refreshFile()
    {
        ...
        file_put_contents(
            APP_PATH . 'extra' . DS . 'agentSite.php',
    ...
    public function rulelist()
    {
        ...
        $regexList = \app\common\model\AgentConfig::getRegexList();
        $list = [];
    ...
    public function emailtest()
    {
        ...
        if ($receiver) {
            ...
            \think\Config::set('site', array_merge(\think\Config::get('agentSite'), $row));
            $email = new Email;
            $result = $email
                ->to($receiver)
